...
5. **Performance Snapshot**: 
   ...
   - **🚨 DO NOT WRITE THE TABLE HTML 🚨**: The automation script will insert `performance_table.html` here
...
6. **Performance Since Inception**:
   ...
   - **🚨 DO NOT WRITE THE CHART SVG 🚨**: The automation script will insert `performance_chart.svg` here
